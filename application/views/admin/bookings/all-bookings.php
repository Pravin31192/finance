    ...
    <div class="row">
        <div class="col-md-2">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <h5>Online Bookings</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">
                        <?php echo !empty($onlineBookings) ? $onlineBookings : 0;?>
                    </h1>
        ...
        <div class="col-md-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">
                        <?php echo !empty($onlineCollection) ? $onlineCollection : 0;?>
                    </h1>
                    <div class="stat-percent font-bold text-success">98% <i class="fa fa-bolt"></i></div>
                    <!-- <small>Total income</small> -->
                </div>
        ...
        <div class="col-md-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">
                        <?php echo !empty($directBookings) ? $directBookings : 0;?>
                    </h1>
        ...
        <div class="col-md-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">
                        <?php echo !empty($directCollection) ? $directCollection : 0;?>
                    </h1>
        ...
        <div class="col-md-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">
                        <?php echo !empty($totalCollection) ? $totalCollection : 0;?>
        ...
        <div class="col-md-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">
                        <?php echo 0;//echo !empty($totalCollection) ? $totalCollection : 0;?>
	...
	<div class="row">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="form-group" id="bookings-daterange">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                                <?php $srno = 1; foreach($allBookings as $tempBookedSlots):?>
                                <tr class="gradeX" id="<?php echo $tempBookedSlots['bookings_id'];?>">
                                    ...
                                    <td><?php echo ($tempBookedSlots['booked_by'] == 2) ? 'Admin' : 'Customer';?></td>
...
<script>
    ...
    $('#bookings-daterange .input-daterange').datepicker({
