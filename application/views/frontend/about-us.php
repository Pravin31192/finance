...
<body>
    ...
    <div class="about-descption block whitebg padding60">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="aboutleft block">
                <img src="<?php echo base_url('assets/frontend/');?>/images/aboutus.jpg" alt="Spunk" class="img-responsive">
                </div>
...
<section> 
    <div class="vision-section backgroundImg padding60 block">
    <div class="container">
        <div class="row">
        <div class="col-sm-4">
            <div class="vision-div block">
            <h3>Vision</h3>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            </div>
            </div>
                <div class="col-sm-4 bdrLRW">
            <div class="vision-div block">
            <h3>Mission</h3>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            </div>
